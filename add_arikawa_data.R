...
dout0 = read_rds("arikawa_jma_dataset.rds")
...
file.copy("arikawa_jma_dataset.rds",
          str_c("arikawa_jma_dataset_until_", start_date, ".rds"))

dout0 |>
  filter(datetime < start_date) |>
  bind_rows(dout) |>
  write_rds("arikawa_jma_dataset.rds")

file.copy("arikawa_jma_dataset.rds",
          "~/Lab_Data/weather/arikawa_jma_dataset.rds",
          overwrite = TRUE)
